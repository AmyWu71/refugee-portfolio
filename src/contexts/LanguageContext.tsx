...
const translations = {
  en: {
    ...
    'nav.contact': 'Contact',
    'home.title': 'A Name, A Chance: Exploring Refugee Issues Through Research and Stories',
  ...
  zh: {
    ...
    'nav.background': '背景',
    'nav.contact': '联系',
    'home.title': '一个名字，一个机会：通过研究和故事探索难民问题',
  ...
  es: {
    ...
    'home.title': 'Un Nombre, Una Oportunidad: Explorando los Problemas de los Refugiados a través de la Investigación y las Historias',
  ...
  my: {
    ...
    'home.title': 'အမည်တစ်ခု၊ အခွင့်အလမ်းတစ်ခု - သုတေသနနှင့် ပုံပြင်များမှတစ်ဆင့် ဒုက္ခသည်များ၏ ပြဿနာများကို လေ့လာခြင်း',
  ...
  th: {
    ...
    'nav.contact': 'ติดต่อ',
    'home.title': 'ชื่อหนึ่ง ชื่อโอกาส: สำรวจปัญหาผู้ลี้ภัยผ่านการวิจัยและเรื่องเล่า',
